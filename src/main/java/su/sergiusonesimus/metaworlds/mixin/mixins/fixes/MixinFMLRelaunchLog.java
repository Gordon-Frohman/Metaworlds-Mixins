...
public abstract class MixinFMLRelaunchLog {
    ...
    public static void log(String targetLog, Level level, String format, Object... data)
    {
		...
		if (format.startsWith("Detected ongoing potential memory lea")) {
			FMLLog.severe("Let me interject for a moment. " + MetaworldsMod.CHANNEL2 + " isn't actually causing any memory leaks, but forge is unfortunately complaining due to the way some packets are handled. You can safely ignore this.", new Object[] {0});
		}
    }
