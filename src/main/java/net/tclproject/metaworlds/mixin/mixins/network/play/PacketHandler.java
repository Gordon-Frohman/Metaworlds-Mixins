package net.tclproject.metaworlds.mixin.mixins.network.play;
...
import net.tclproject.metaworlds.mixin.mixins.network.play.client.IMixinC03PacketPlayer;
import net.tclproject.metaworlds.mixin.mixins.network.play.server.IMixinS14PacketEntity;
import net.tclproject.metaworlds.mixin.mixins.network.play.server.IMixinS18PacketEntityTeleport;

public class PacketHandler {

    @SideOnly(Side.CLIENT)
    public static C06PacketPlayerPosLook getC06PacketPlayerPosLook(double p_i45254_1_, double p_i45254_3_, double p_i45254_5_, double p_i45254_7_, float p_i45254_9_, float p_i45254_10_, boolean p_i45254_11_, int worldBelowFeetId, byte parTractionLoss, boolean parLosingTraction)
    {
    	C06PacketPlayerPosLook c06 = new C06PacketPlayerPosLook(p_i45254_1_, p_i45254_3_, p_i45254_5_, p_i45254_7_, p_i45254_9_, p_i45254_10_, p_i45254_11_);
    	return (C06PacketPlayerPosLook)((IMixinC03PacketPlayer)(Object)c06).setSubWorldBelowFeetId(worldBelowFeetId).setTractionLoss(parTractionLoss).setLosingTraction(parLosingTraction);
    }
    ...
    public static S15PacketEntityRelMove getS15PacketEntityRelMove(int p_i45203_1_, int worldBelowFeetId,
        ...
        S15PacketEntityRelMove s15 = new S15PacketEntityRelMove(
            p_i45203_1_,
            p_i45203_2_,
            p_i45203_3_,
            p_i45203_4_);
    ...
    public static S16PacketEntityLook getS16PacketEntityLook(int p_i45205_1_, int worldBelowFeetId, byte parTractionLoss, boolean parLosingTraction, byte p_i45205_2_, byte p_i45205_3_) {
    	S16PacketEntityLook s16 = new S16PacketEntityLook(
    		p_i45205_1_,
            p_i45205_2_,
            p_i45205_3_);
    ...
    public static S18PacketEntityTeleport getS18PacketEntityTeleport(int p_i45234_1_, int parSubWorldId, byte parTractionLoss, boolean parLosingTraction, int p_i45234_2_, int p_i45234_3_, int p_i45234_4_, byte p_i45234_5_, byte p_i45234_6_, byte subWorldFlag, int xOnSubWorld, int yOnSubWorld, int zOnSubWorld)
    {
    	S18PacketEntityTeleport s18 = new S18PacketEntityTeleport(p_i45234_1_, p_i45234_2_, p_i45234_3_, p_i45234_4_, p_i45234_5_, p_i45234_6_);
