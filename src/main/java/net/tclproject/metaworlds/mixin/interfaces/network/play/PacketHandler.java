package net.tclproject.metaworlds.mixin.interfaces.network.play;
...
import net.tclproject.metaworlds.mixin.interfaces.network.play.client.IMixinC03PacketPlayer;
